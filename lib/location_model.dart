class LocationData {
  ...
  LocationData(this.latitude, this.longitude, this.accuracy, this.altitude, this.speed, this.speedAccuracy, this.heading, this.time, this.isMock); // Is the location currently mocked
}
